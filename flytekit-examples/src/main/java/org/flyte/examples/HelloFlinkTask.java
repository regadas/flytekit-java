...
import org.flyte.flytekit.flink.FlinkTask;

/** Hello World in Flyte. */
@AutoService(FlinkTask.class)
public class HelloFlinkTask extends FlinkTask {

  public HelloFlinkTask() {}

  @Override
  public FlinkJob getFlinkJob() {
    return FlinkJob.newBuilder()
